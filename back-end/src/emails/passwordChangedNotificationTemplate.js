/**
 * Email template for successful password change notification.
 *
 * @param {string} email - The user's email address
 * @returns {string} HTML string for the email body
 */
const passwordChangedNotificationTemplate = (email) => {
  const now = new Date();
...
<head>
  ...
  <title>Password Berhasil Diubah - Apotek Pemuda Farma</title>
</head>
          ...
          <tr>
            <td style="padding: 32px 28px;">
              ...
              <p style="color: #334155; margin: 0 0 20px; font-size: 15px; line-height: 1.6; text-align: center;">
                Password akun <strong>${email}</strong> telah berhasil diperbarui pada:
              </p>

              <div style="text-align: center; margin: 16px 0 24px;">
                <span style="display: inline-block; background: #f0fdfa; border: 1px solid #99f6e4; border-radius: 10px; padding: 10px 24px; color: #0f766e; font-weight: 700; font-size: 15px;">
                  📅 ${formattedDate} WIB
                </span>
              </div>
              ...
              <div style="background: #fef2f2; border-left: 4px solid #ef4444; border-radius: 8px; padding: 14px 18px; margin: 24px 0;">
                ...
                <p style="margin: 6px 0 0; color: #b91c1c; font-size: 12px;">
                  Segera hubungi tim kami untuk mengamankan akun Anda. Jangan bagikan password Anda kepada siapa pun.
                </p>
              </div>
            </td>
          </tr>
